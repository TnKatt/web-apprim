...
if (!$id_gedung || !$kode_ruangan) {
    header("Location: ../admin/daftar-ruang.php?error=ID Gedung atau Kode Ruangan tidak valid.");
    exit();
}
...
if ($result_gedung->num_rows === 0) {
    header("Location: ../admin/daftar-ruang.php?error=Gedung tidak ditemukan.");
    exit();
}
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="../admin/daftar-ruang.php?id_gedung=<?= $id_gedung ?>" class="back-btn">< Kembali ke Daftar Ruang</a>
                ...
                <form action="../admin/edit-ruang.php?id_gedung=<?= $id_gedung ?>&kode_ruangan=<?= htmlspecialchars($kode_ruangan) ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="nik_pic" id="nik_pic" value="<?= htmlspecialchars($ruangan['nik_pic'] ?? '') ?>" placeholder="Kosongkan jika belum ditentukan" oninput="updateNamaPIC()">
