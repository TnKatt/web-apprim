...
<head>
    ...
    <title>APPRIM | Halaman Utama</title>
    <link rel="stylesheet" href="../back-end/admin/halaman-utama.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="sidebar">
                ...
                <div class="content">
                    <!-- Button Tambah Gedung -->
                    <h1>Daftar Gedung</h1>
                    <a href="../admin/tambah-gedung.php" class="add-building-btn">Tambah Gedung</a>

                    <?php if ($result_gedung->num_rows > 0) : ?>
                            ...
                            <div class="building-box">
                                ...
                                <div class="building-right">
                                    ...
                                    <div class="button-container">
                                        <a href="../admin/edit-gedung.php?id=<?= $gedung['id_gedung'] ?>" class="edit-building-btn">Edit Gedung</a>
                                        <a href="../admin/daftar-ruang.php?id_gedung=<?= $gedung['id_gedung'] ?>" class="choose-room-btn">Pilih Ruang</a>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
                    <?php else : ?>
                        <p>Tidak ada data ruangan yang didaftarkan</p>
                    <?php endif; ?>
                </div>
            </div>
