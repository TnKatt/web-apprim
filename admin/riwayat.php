...
<head>
    ...
    <link rel="stylesheet" href="../back-end/admin/riwayat.css">
                        ...
                        if ($result_riwayat->num_rows > 0) {
                            while ($row = $result_riwayat->fetch_assoc()) {
                                ...
                                if ($tombolBatalkanVisible) {
                                    echo '<a href="../admin/pembatalan.php?id_peminjaman=' . $row['id_peminjaman'] . '&kode_ruangan=' . $row['kode_ruangan'] . '">';
                                ...
                                // Tombol Detail
                                echo '<a href="../admin/detail-riwayat.php?id=' . $row['id_peminjaman'] . '">';
