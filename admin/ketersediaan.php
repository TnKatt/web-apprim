<?php
    ...
    // Ambil data ruangan berdasarkan kode_ruangan
    ...
    // Ambil data peminjaman berdasarkan kode_ruangan
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a class="tambah-pengguna" href="../admin/daftar-ruang.php?id_gedung=<?= htmlspecialchars($ruangan_data['id_gedung']) ?>" class="back-button">Kembali ke Daftar Ruang</a>
                        ...
                        <tbody>
                            <?php while ($peminjaman = $result_peminjaman->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= formatTanggalIndonesia($peminjaman['tanggal_pemakaian']); ?>
                                    </td>
