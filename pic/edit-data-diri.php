<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        header("Location: ../pic/data-diri.php");
        exit();
    }
                    ...
                    <div class="content">
                        <div class="building-box">
                            ...
                            <div class="building-right">
                                ...
                                <form action="../pic/update-data-diri.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="button-container">
                                        ...
                                        <?php if ($foto_user != $defaultPhoto): ?>
                                            <a href="../pic/hapus-foto.php" class="delete-button">Hapus Foto</a>
                                        <?php endif; ?>
                                        <!-- Tombol Simpan: Menyimpan foto profil dan email -->
                                        <a href="../pic/data-diri.php" class="delete-button">Batal</a>
