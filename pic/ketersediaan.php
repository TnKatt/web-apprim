<?php
    ...
    // Mengecek apakah peran pengguna adalah 'pic'
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../back-end/pic/data-pengguna.css">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="../pic/daftar-ruang.php?id_gedung=<?= htmlspecialchars($ruangan_data['id_gedung']) ?>" class="tambah-pengguna">Kembali ke Daftar Ruang</a>
