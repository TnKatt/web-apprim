...
<head>
    ...
    <link rel="stylesheet" href="../back-end/pic/data-diri.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="navigation">
                <ul class="nav-list">
                    <li><a href=".../pic/beranda.php">Beranda</a></li>
                    ...
                    <div class="building-box">
                        ...
                        <div class="building-right">
                            ...
                            <div class="button-container">
                                <a href="../pic/ganti-kata-sandi.php" class="edit-building-btn">Ganti Kata Sandi</a>
                                <a href="../pic/edit-data-diri.php" class="choose-room-btn">Edit Data Diri</a>
                            </div>
                        </div>
                    </div>
                </div>
