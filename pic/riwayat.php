...
<head>
    ...
    <link rel="stylesheet" href="../back-end/pic/riwayat.css">
                        ...
                        if ($result_riwayat->num_rows > 0) {
                            while ($row = $result_riwayat->fetch_assoc()) {
                                ...
                                if ($tombolNilaiVisible) {
                                    echo '<a href="../pic/isi-penilaian.php?id_peminjaman=' . $row['id_peminjaman'] . '">';
                                ...
                                // Tombol Detail
                                echo '<a href="../pic/detail-riwayat.php?id_peminjaman=' . $row['id_peminjaman'] . '">';
...
<script>
    ...
    function confirmCancel(idPeminjaman) {
        ...
        if (result) {
            ...
            window.location.href = "../pic/pembatalan.php?id_peminjaman=" + idPeminjaman;
        }
    }
