<?php
    ...
    // Mengecek apakah peran pengguna adalah 'dosen'
    if ($role_user !== 'Dosen') {
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="../dosen/daftar-ruang.php?id_gedung=<?= htmlspecialchars($ruangan_data['id_gedung']) ?>" class="tambah-pengguna">Kembali ke Daftar Ruang</a>
