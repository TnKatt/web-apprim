...
<head>
    ...
    <link rel="stylesheet" href="../back-end/dosen/halaman-utama.css">
                            ...
                            <div class="building-box">
                                ...
                                <div class="building-right">
                                    ...
                                    <div class="button-container">
                                        <a href="../dosen/daftar-ruang.php?id_gedung=<?= $gedung['id_gedung'] ?>" class="choose-room-btn">Pilih Ruang</a>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
                    <?php else : ?>
                        <p style="text-align: center; font-size: 18px; font-weight: bold; margin-top: 20px;">Tidak ada data Gedung yang dimasukkan.</p>
                    <?php endif; ?>
                </div>
            </div>
