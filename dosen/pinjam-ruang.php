...
// Batasi akses hanya untuk dosen
if ($role_user !== 'Dosen') {
...
<head>
    ...
    <link rel="stylesheet" href="../back-end/dosen/pinjam-ruang.css">
</head>
<body>
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="../dosen/daftar-ruang.php?id_gedung=<?=$id_gedung ?>" class="back-btn">< Kembali ke Ruangan</a>
                ...
                <form action="../dosen/validasi-pinjam.php?id_gedung=<?= $id_gedung ?>&kode_ruangan=<?= $kode_ruang ?>" method="POST">
