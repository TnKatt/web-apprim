...
<head>
    ...
    <link rel="stylesheet" href="../back-end/dosen/data-diri.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="navigation">
                <ul class="nav-list">
                    <li><a href=".../dosen/beranda.php">Beranda</a></li>
                        ...
                        <div class="building-right">
                            ...
                            <table class="profile-info">
                                ...
                                <tr>
                                    <td>Email</td>
                                    <td>:</td>
                                    <td><?= !empty($email) ? htmlspecialchars($email) : "Email belum dimasukkan" ?></td>
                                </tr>
                            </table>
 
                            <div class="button-container">
                                <a href="../dosen/ganti-kata-sandi.php" class="edit-building-btn">Ganti Kata Sandi</a>
                                <a href="../dosen/edit-data-diri.php" class="choose-room-btn">Edit Data Diri</a>
                            </div>
                        </div>
                    </div>
                </div>
