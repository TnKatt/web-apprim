<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        header("Location: ../dosen/data-diri.php");
        exit();
    }
                    ...
                    <div class="content">
                        <div class="building-box">
                            ...
                            <div class="building-right">
                                ...
                                <form action="../dosen/update-data-diri.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="button-container">
                                        ...
                                        <?php if ($foto_user != $defaultPhoto): ?>
                                            <a href="../dosen/hapus-foto.php" class="delete-button">Hapus Foto</a>
                                        <?php endif; ?>
                                        <!-- Tombol Simpan: Menyimpan foto profil dan email -->
                                        <a href="../dosen/data-diri.php" class="delete-button">Batal</a>
