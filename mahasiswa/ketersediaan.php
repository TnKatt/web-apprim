<?php
    ...
    // Mengecek apakah peran pengguna adalah 'mahasiswa'
    ...
    $stmt_peminjaman = $conn->prepare("
        ...
        WHERE 
            ...
            AND peminjaman.status_peminjaman != 'Dibatalkan'  -- Kondisi baru ditambahkan di sini
        ORDER BY 
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../back-end/mahasiswa/data-pengguna.css">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="../mahasiswa/daftar-ruang.php?id_gedung=<?= htmlspecialchars($ruangan_data['id_gedung']) ?>" class="tambah-pengguna">Kembali ke Daftar Ruang</a>
